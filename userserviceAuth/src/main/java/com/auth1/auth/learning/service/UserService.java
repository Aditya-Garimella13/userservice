...
import com.auth1.auth.learning.dtos.CreateUserEmailDto;
...
public class UserService {
    ...
    public User signUp(String email, String password, String name){
        ...
        CreateUserEmailDto message = new CreateUserEmailDto();
        message.setFrom("adiyaa606@gmail.com");
        message.setTo(user.getEmail());
        message.setSubject("Welcome mail");
        message.setBody("Hi welcome to kafka");

        try {
            kafkaTemplate.send("emailMessage",mapper.writeValueAsString(message));
